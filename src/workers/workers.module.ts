...
@Module({
  imports: [PrismaModule, QueueModule, JobsModule, ConversationsModule, MessagesModule, BotEngineModule],
  providers: [IncomingMessageWorker, OutgoingMessageWorker, FollowupWorker, ProviderEventsWorker],
})
